...
- Artifact Detection and Mitigation: Flags and handles issues like bisulfite failure, low coverage, sample contamination, duplicates, sex-metadata mixups, and clonal VDJ artifacts.
